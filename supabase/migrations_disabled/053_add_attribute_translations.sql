...
UPDATE public.attribute_options SET translations = '{"ar": "إطلالة كاملة على النهر", "fr": "Vue complète sur la rivière", "es": "Vista completa al río"}'::jsonb WHERE code = 'full_river_view';
