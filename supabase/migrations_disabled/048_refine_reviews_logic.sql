-- =============================================================================
-- Migration 048: Refine Reviews Logic (Decimals & Private Feedback)
-- =============================================================================

-- 1. Drop trigger that depends on column types (Postgres restriction)
...
-- 4. Recreate the trigger (logic remains the same as it already handled NUMERIC aggregates)
...
-- Note: In a production app, we would ideally have a separate column or a view to hide the 'private_feedback' field from public selects.
-- For this prototype, we'll keep it simple but acknowledge that staff and hosts can see it.
