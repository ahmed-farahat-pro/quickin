-- =============================================================================
-- Migration 045: Review Categories & Moderation
-- =============================================================================

-- Add sub-ratings and moderation flags to the existing reviews table
...
-- Ensure RLS allows admins/moderators to view and edit reviews
...
-- Filter public select queries to exclude hidden reviews, unless the user owns them or is staff
